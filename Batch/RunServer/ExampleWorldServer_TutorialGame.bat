...
echo Run '[T4Framework] WorldServer - TutorialGame'
...
call %UE4_EDIT_EXE% "%~dp0../../VirtualFlowBeta.uproject" -run=T4WorldServerService -ProjectID=TutorialGame -IP=210.99.39.195 -Port=1232 -WorldID=Gardens
